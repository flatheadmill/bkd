...
fn main() {
    ...
    println!(
        "  A: ({}, {})",
        original_triangle.a_x, original_triangle.a_y
    );
    println!(
        "  B: ({}, {})",
        original_triangle.b_x, original_triangle.b_y
    );
    println!(
        "  C: ({}, {})",
        original_triangle.c_x, original_triangle.c_y
    );
    println!(
        "  Edges from shape: AB={}, BC={}, CA={}",
    ...
    for (i, chunk) in encoded_bytes.chunks(4).enumerate() {
        ...
        println!(
            "  Dimension {}: {} (bytes: {:02x} {:02x} {:02x} {:02x})",
